...
class ArchPostingFromThreadActivity : AppCompatActivity() {

    private lateinit var viewModel: ArchPostingFromThreadViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(ArchPostingFromThreadViewModel::class.java)
